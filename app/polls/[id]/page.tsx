      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-lg shadow-md p-8">
          <div className="mb-8">
            ...
            <p className="text-sm text-gray-500">Poll ID: {id}</p>
            {poll.total_votes !== undefined && (
              <p className="text-sm text-gray-500">Total votes: {poll.total_votes}</p>
            )}
          </div>
                  ...
                  {poll.options
                    ...
                    <div key={option.id} className="flex items-center">
                      ...
                      <label 
                        ...
                        className="ml-3 block text-sm font-medium text-gray-700 cursor-pointer hover:text-gray-900 transition-colors"
                      >
                        {option.option_text}
                      </label>
                    </div>
