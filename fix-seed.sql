...
-- Fixed to work with UUID primary keys
...
BEGIN
  ...
  -- Insert options for poll 4 (FIXED: use poll4_id variable instead of currval)
  INSERT INTO poll_options (poll_id, option_text, option_order) VALUES
    (poll4_id, 'VS Code', 1),
    (poll4_id, 'IntelliJ IDEA', 2),
    (poll4_id, 'Vim/Neovim', 3),
    (poll4_id, 'Sublime Text', 4),
    (poll4_id, 'Atom', 5),
    (poll4_id, 'WebStorm', 6);
  ...
  -- Insert options for poll 5 (FIXED: use poll5_id variable instead of currval)
  INSERT INTO poll_options (poll_id, option_text, option_order) VALUES
    (poll5_id, 'Yes, eventually', 1),
    (poll5_id, 'No, never', 2),
    (poll5_id, 'Partially, some tasks', 3),
    (poll5_id, 'Uncertain', 4);
  ...
  RAISE NOTICE 'Poll 4 ID: % (multiple votes)', poll4_id;
  RAISE NOTICE 'Poll 5 ID: % (AI poll)', poll5_id;
